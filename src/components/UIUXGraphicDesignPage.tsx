    ...
    <div className="min-h-screen bg-white text-dark relative overflow-hidden" ref={containerRef}>
            ...
            >
              ...
              >
                ...
                <motion.g>
                  {/* Tools Icons */}
                  {[
                    { x: 180, y: 180, tool: "Pen" },
                    { x: 230, y: 180, tool: "Shape" },
                    { x: 280, y: 180, tool: "Text" },
                    { x: 330, y: 180, tool: "Color" }
                  ].map((tool, i) => (
                    <motion.rect
                      key={i}
                      x={tool.x}
                ...
                <motion.g>
                  <motion.path
                    d="M200 600 L600 600 M220 580 L580 620"
                    stroke="white"
                    strokeWidth="2"
                    animate={{
                      pathLength: [0, 1, 0],
      ...
      <section className="relative py-16 md:py-32 bg-gray-50">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            className="absolute top-1/2 left-0 w-full h-1 bg-gradient-to-r from-primary to-primary/0"
            initial={{ width: 0 }}
