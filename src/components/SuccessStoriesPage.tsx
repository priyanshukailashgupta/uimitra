  ...
  const successStories: SuccessStory[] = [
    {
      ...
      testimonial: "The UI Mitra team didn't just deliver a website; they delivered a complete digital transformation that has revolutionized our business. Their attention to detail and user-centric approach has helped us achieve results we never thought possible.",
      metrics: [
    ...
    },
    {
      ...
      testimonial: "UI Mitra's expertise in creating intuitive healthcare interfaces has been instrumental in our success. They understood the unique challenges of healthcare UX and delivered a solution that has transformed how we provide care.",
      metrics: [
