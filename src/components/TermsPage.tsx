...
const faqs = [
  {
    ...
    question: 'What are the Terms & Conditions for using UI Mitra?',
    answer: 'By accessing or using UI Mitra, you agree to follow these Terms & Conditions. If you do not agree, please do not use our services. These terms may be updated from time to time, and continued use means you accept any changes.',
  },
  {
    id: 'user',
    icon: <User className="w-6 h-6 text-primary/70" />,
    question: 'What are my responsibilities as a user?',
    answer: 'You must provide accurate information, keep your login details secure, and use UI Mitra only for lawful purposes. Do not attempt to hack, disrupt, or misuse the platform. You are responsible for all activity under your account.',
  },
  {
    id: 'ip',
    icon: <Book className="w-6 h-6 text-primary/70" />,
    question: 'Who owns the content and intellectual property?',
    answer: 'All content, branding, and intellectual property on UI Mitra belong to us or our licensors. You may not copy, share, or use our content without written permission. Content you create remains yours, but you grant us a license to use it for providing our services.',
  },
  {
    id: 'liability',
    icon: <AlertTriangle className="w-6 h-6 text-primary/70" />,
    question: 'What are the limitations of liability?',
    answer: 'UI Mitra is provided as-is. We do not guarantee uninterrupted or error-free service. We are not liable for any indirect, incidental, or consequential damages resulting from your use of the platform.',
  },
  {
    id: 'termination',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-light to-white">
      <div className="bg-gradient-to-r from-primary to-secondary text-white py-12 px-4 text-center shadow-lg">
        ...
        <p className="text-lg md:text-xl mb-2">Please read these terms and conditions carefully before using UI Mitra</p>
